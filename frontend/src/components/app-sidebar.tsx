...
export function AppSidebar({ data, onSelectView, selectedView, onAddLink, ...props }: React.ComponentProps<typeof Sidebar> & { data: string[], onSelectView?: (view: string) => void, selectedView?: string, onAddLink?: (link: string) => void }) {
  return (
    <Sidebar collapsible="offcanvas" {...props}>
          ...
          <SidebarMenuItem>
            ...
            >
              <a href="#">
                ...
                <span className="text-base font-semibold">Go Link</span>
              </a>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      ...
      <SidebarContent>
        {/* TODO: this will be the list of links user adds to shorten */}
        <NavMain items={data} onSelectView={onSelectView} selectedView={selectedView} onAddLink={onAddLink} />
